      ...
      <div className="space-y-4 p-4 lg:grid lg:grid-cols-2 lg:items-start lg:gap-4 lg:space-y-0">
          ...
          {["owner", "office_staff"].includes(profile.role) && (
            <>
              <Link href="/kiosk" className="flex items-center justify-between border-t border-gray-100 px-4 py-3.5">
                <span className="font-medium text-gray-800">🖥️ Attendance Kiosk</span>
                <span className="text-gray-400">›</span>
              </Link>
              <Link href="/kpi" className="flex items-center justify-between border-t border-gray-100 px-4 py-3.5">
        ...
        {profile.role === "owner" && (
          <div className="overflow-hidden rounded-xl border border-gray-200 bg-white">
            ...
            <Link href="/reports/business-kpi" className="flex items-center justify-between border-t border-gray-100 px-4 py-3.5">
            ...
            <Link href="/reports/bir-books" className="flex items-center justify-between border-t border-gray-100 px-4 py-3.5">
              <span className="font-medium text-gray-800">📚 BIR Books (Sales, Purchases, Ledger)</span>
              <span className="text-gray-400">›</span>
            </Link>
            ...
            <Link href="/settings/certificate-template" className="flex items-center justify-between border-t border-gray-100 px-4 py-3.5">
              <span className="font-medium text-gray-800">🏅 Certificate Template</span>
              <span className="text-gray-400">›</span>
            </Link>
            <Link href="/settings/completion-template" className="flex items-center justify-between border-t border-gray-100 px-4 py-3.5">
              <span className="font-medium text-gray-800">🏁 Completion Template</span>
              <span className="text-gray-400">›</span>
            </Link>
            <Link href="/settings/users" className="flex items-center justify-between border-t border-gray-100 px-4 py-3.5">
