    ...
    <>
      ...
      <div className="space-y-4 p-4">
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-4">
          ...
          <p className="mb-2 text-xs text-gray-500">
            Net profit margin (benchmark 5–15%, healthy ≥10%), employee
                  ...
                  <tr key={m.label} className={`border-b border-gray-50 ${i === monthly.length - 1 ? "font-semibold" : ""}`}>
                    ...
                    <td className="py-1.5 pr-3 text-right">
                      {m.netMargin === null ? (
                        ...
                        <span className={m.netMargin < 0.05 ? "font-semibold text-red-600" : m.netMargin < 0.1 ? "text-amber-600" : "text-brand-green-dark"}>
                          {pct(m.netMargin)}
                        </span>
                      )}
                    </td>
