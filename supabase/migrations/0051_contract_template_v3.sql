-- Contract template v3, matching the signed agreement IA-2026-0020:
-- payment scheme moved to the front of section 5 (clauses 5.1 / 5.1.x),
-- bank accounts renumbered to 5.2.x with two LBP accounts added,
-- inclusions renumbered 5.3/5.3.1, and the Rapid Shutdown Device warranty
-- clause removed (warranties renumbered 7.4/7.5).
...
5.2 Cash or check payable to LORENZO G. ESPINA

Bank Accounts:

METROBANK:
5.2.1 Personal Savings Account Name: Lorenzo G. Espina
Bank Account No.: 660-3-66082394-9

BDO:
5.2.2 Personal Savings Account Name: Lorenzo G. Espina
Bank Account No.: 008040163299

CHINA SAVINGS BANK:
5.2.3 Personal Savings Account Name: Lorenzo G. Espina
Bank Account No.: 629502000379

PNB:
5.2.4 Personal Savings Account Name: Lorenzo G. Espina
Bank Account No.: 308610262761

LBP:
5.2.5 Business Account Name: Lorenzo G. Espina
Bank Account No.: 6011019658

LBP:
5.2.6 Personal Savings Account Name: Lorenzo G. Espina
Bank Account No.: 6016094895

5.3 This cost is inclusive of all materials, all labor and all testing and commissioning of the {{SYSTEM_SHORT}} system, and as per inclusions below:
5.3.1 This includes all materials shown on SL Diagram, and materials not shown on SL Diagram, if required for installation, operability, maintainability, or for compliance to the Philippine Electrical Code, Local Codes or safety reasons.
...
7.4 System installation and free service warranty: 3 years.
7.4.1 Trouble-shooting works, if required, shall be done during office hours of working days (Mondays-Saturdays) only, unless otherwise agreed by both Parties.
7.4.2 First Party shall provide free cleaning of solar panels, inverter and battery setup once a year within the warranty period only. Any related works after the warranty period shall have a corresponding maintenance fee.
7.5 All equipment warranty claims shall be in accordance to manufacturer's warranty policy.
